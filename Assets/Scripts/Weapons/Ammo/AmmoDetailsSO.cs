...
public class AmmoDetailsSO : ScriptableObject
{
    ...
    [Tooltip("Populate with the prefab to be used for the ammo. If multiple prefabs are specified then a random prefab from the array will be selected." +
        "The prefab can be an ammo pattern - as lond as it conforms to the IFireable interace.")]
    #endregion
    ...
    #region Tooltip
    [Tooltip("If the ammo should 'charge' briefly before moving then set the time in second that the ammo is held charging after firing before release")]
    #endregion
    ...
    #region Tooltip
    [Tooltip("This is the maximum number of ammo that are spawn per shot. A random number of ammo are spawned between the minimum and maximum values")]
    #endregion
    public int ammoSpawnAmountMax = 1;

    #region Tooltip
    [Tooltip("Minimum spawn interval time. The time interval in seconds between spawned ammo is a random value between" +
        " the minimum and maximum values specified.")]
    #endregion
    public float ammoSpawnIntervalMin = 0f;

    #region Tooltip
    [Tooltip("Maximum spawn interval time. The time interval in seconds between spawned ammo is a random value between" +
        " the minimum and maximum values specified.")]
    #endregion
    ...
    #region Tooltip
    [Tooltip("Ammo Trail Lifetime in seconds (ex. persistent laser beams have longer (higher) trail times)")]
    #endregion
    ...
    #region Tooltip
    [Tooltip("Ending width of the ammo trail")]
    #endregion
    ...
    private void OnValidate()
    {
        ...
        if (ammoChargeTime > 0) HelperUtilities.ValidateCheckNullValue(this, nameof(ammoChargeMaterial), ammoChargeMaterial);

        // AMMO BASE PARAMETERS

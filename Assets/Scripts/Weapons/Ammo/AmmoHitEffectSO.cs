...
public class AmmoHitEffectSO : ScriptableObject
{
    ...
    #region Tooltip
    [Tooltip("The color gradient for the hit effect. This gradient shows the color of particles during their lifetimes - from left to right.")]
    #endregion
    ...
    #region Tooltip
    [Tooltip("Contains the particle system for the hit effect and is configured by the ammo hit effect SO")]
    #endregion

...
public class DungeonBuilder : SingletonMonobehavior<DungeonBuilder>
{
    ...
    {
        // Set dimmed material to fully visible (if we need to look at the room when this script is not running)
    ...
    private Room CreateRoomFromRoomTemplate(RoomTemplateSO roomTemplate, RoomNodeSO roomNode)
    {
        ...
        // If there are no enemies to spawn, set the room to be cleared of enemies

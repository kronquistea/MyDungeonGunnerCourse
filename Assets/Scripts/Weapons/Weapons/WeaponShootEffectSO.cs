...
public class WeaponShootEffectSO : ScriptableObject
{
    ...
    #region Tooltip
    [Tooltip("The color gradient for the shoot effect. This gradient shows the color of particles during their lifetimes - from left to right.")]
    #endregion
    ...
    #region Tooltip
    [Tooltip("The minimum velocity for the particle over its lifetime. A random value between min and max will be generated")]
    #endregion
    public Vector3 velocityOverLifetimeMin;

    #region Tooltip
    [Tooltip("The maximum velocity for the particle over its lifetime. A random value between min and max will be generated")]
    #endregion
    public Vector3 velocityOverLifetimeMax;

    #region Tooltip
    [Tooltip("Contains the particle system for the shoot effect and is configured by the weapon shoot effect SO")]
    #endregion

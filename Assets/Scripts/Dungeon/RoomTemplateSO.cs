...
public class RoomTemplateSO : ScriptableObject
{
    ...
    #region Tooltip
    [Tooltip("The room node type SO. The room node typescorrespond to the room nodes used in the room node graph. " +
        "The exceptions being with corridors. In the room node graph there is just one corridor types 'Corridor'. " +
    ...
    #region Tooltip
    [Tooltip("There should be a maximum of four doorways for a room - one for each cardinal direction. " +
        "These should have a consistent 3 tile opening size, " +
        "with the moddile size position being the doorway coordinate 'position'")]
    #endregion Tooltip
    ...
    /// </summary>
    /// <returns>List of Doorway</returns>

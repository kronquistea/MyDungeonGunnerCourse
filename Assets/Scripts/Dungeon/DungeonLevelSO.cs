...
public class DungeonLevelSO : ScriptableObject
{
    ...
    #region Tooltip
    [Tooltip("Populate the list with the room templates that you want to be part of this level." +
    ...
    private void OnValidate()
    {
        ...
        // Checks to make sure that room templates are specified for all the node types in the specified node graphs
        // CHECK 1: E/W corridor, N/S corridor, and entrance types have been specified
        ...
        foreach (RoomTemplateSO roomTemplateSO in roomTemplateList)
        {
            ...
            if (roomTemplateSO.roomNodeType.isCorrdorEW)
            {
                isEWCorridor = true;
            }
        ...
        foreach (RoomNodeGraphSO roomNodeGraph in roomNodeGraphList)
        {
            ...
            foreach (RoomNodeSO roomNodeSO in roomNodeGraph.roomNodeList)
            {
                ...
                if (roomNodeSO.roomNodeType.isEntrance ||
                    roomNodeSO.roomNodeType.isCorrdorEW ||
